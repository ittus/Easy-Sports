...
import com.gec.easysports.font.RobotoTextView;
import com.gec.easysports.font.RobotoTextView.Roboto;
...
public class CircularProgressButton extends Button {
    ...
    private void initAttributes(Context context, AttributeSet attributeSet) {
        TypedArray attr = context.obtainStyledAttributes(attributeSet, R.styleable.CircularProgressButton);
        if (attr == null) {
            return;
        }
