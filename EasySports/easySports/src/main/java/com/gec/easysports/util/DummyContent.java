...
import com.gec.easysports.model.ImageGallerySubcategoryModel;
...
public class DummyContent {
    ...
    public static ArrayList<ImageGalleryCategoryModel> getImageGalleryMusicCategories(List<String> currentChannel) {
        ArrayList<ImageGalleryCategoryModel> imageGalleryCategoryModels = new ArrayList<ImageGalleryCategoryModel>();

        ImageGalleryCategoryModel imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(0L);
        imageGalleryCategoryModel.setUrl("http://www.badmintoncentral.com/forums/attachment.php?attachmentid=84072&d=1290915949");
        imageGalleryCategoryModel.setTitle("Badminton");

        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Badminton"));
        ...
        imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(1L);
        imageGalleryCategoryModel.setUrl("http://alumni.alvernia.edu/s/1480/images/editor/basketball_image.jpg");

        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Basketball"));

        imageGalleryCategoryModel.setTitle("Basketball");
        ...
        imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(2L);
        imageGalleryCategoryModel.setUrl("http://www.kenmorelanes.net/bowling_ball-13516.jpg");
        imageGalleryCategoryModel.setTitle("Bowling");
        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Bowling"));
        imageGalleryCategoryModel.setSubcategories(getImageGallerySaxophonesSubcategory());
        imageGalleryCategoryModels.add(imageGalleryCategoryModel);

        imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(3L);
        imageGalleryCategoryModel.setUrl("http://static.wixstatic.com/media/c32172_5aa2c4c9c6cf47ca00721b858a3ae8e9.jpg");
        imageGalleryCategoryModel.setTitle("Cricket");
        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Cricket"));
        imageGalleryCategoryModel.setSubcategories(getImageGalleryTrumpetsSubcategory());
        imageGalleryCategoryModels.add(imageGalleryCategoryModel);

        imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(4L);
        imageGalleryCategoryModel.setUrl("http://cobrapremiersoccer.webs.com/European-Soccer.jpg");
        imageGalleryCategoryModel.setTitle("Football");
        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Football"));
        imageGalleryCategoryModel.setSubcategories(getImageGalleryPianosSubcategory());
        imageGalleryCategoryModels.add(imageGalleryCategoryModel);

        imageGalleryCategoryModel = new ImageGalleryCategoryModel();
        imageGalleryCategoryModel.setId(5L);
        imageGalleryCategoryModel.setUrl("https://upload.wikimedia.org/wikipedia/commons/b/be/Table_tennis_Rio_2007.jpg");
        imageGalleryCategoryModel.setTitle("Table Tennis");
        imageGalleryCategoryModel.setFavourite(currentChannel.contains("Table Tennis"));
    ...
    public static ArrayList<DummyModel> getDummyModelGoogleCardsTravelList() {
        ...
        list.add(new DummyModel(0, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/0.jpg", "Climbing tour", R.string.fontello_heart_empty));
        list.add(new DummyModel(1, "http://pengaja.com/uiapptemplate/newphotos/listviews/googlecards/travel/1.jpg", "Diving in sea", R.string.fontello_heart_empty));
        list.add(new DummyModel(2, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Soccer in Raffle", R.string.fontello_heart_empty));
        list.add(new DummyModel(3, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Basketball in XXX", R.string.fontello_heart_empty));
        list.add(new DummyModel(4, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Badminton in YYY", R.string.fontello_heart_empty));
        list.add(new DummyModel(5, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Tennis competition", R.string.fontello_heart_empty));
        list.add(new DummyModel(6, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Running contest", R.string.fontello_heart_empty));
        list.add(new DummyModel(7, "http://www2.hull.ac.uk/hubs/images/football-large.jpg", "Karate training", R.string.fontello_heart_empty));
